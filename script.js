...
searchBar.formSubmit = () => {
    ...
    searchBar.searchForm.addEventListener("submit", function (e) {
        ...
        if (!searchBar.searchInput.classList.contains("searchInputOpen")) {
            ...
            searchBar.searchIcon.style.color = "#00050f";
            ...
            document.addEventListener("click", function (event) {
                ...
                if (
                    event.target != searchBar.searchInput &&
                    event.target != searchBar.searchButton &&
                    event.target != searchBar.searchIcon &&
                    event.target != searchBar.modal
                ) {
                    // hide search bar
    ...
    searchBar.searchInput.addEventListener("keydown", (keystrokes) => {
        ...
        content.forEach(function (element) {
            ...
            setTimeout(function () {
                ...
                if (
                    searchBar.searchInput.value &&
                    searchBar.searchInput.value.replace(/\s/g, "").length != 0
                ) {
                    // Show results modal
